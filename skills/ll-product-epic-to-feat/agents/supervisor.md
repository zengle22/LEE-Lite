...
4. Verify that each FEAT is still a FEAT: it must remain independently acceptable, traceable to the EPIC, and ready for downstream delivery-prep and plan flows.
