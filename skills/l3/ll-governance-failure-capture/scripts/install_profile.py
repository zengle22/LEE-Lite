#!/usr/bin/env python3
"""
Compatibility wrapper for installing ll-governance-failure-capture.
...
SKILL_NAME = "ll-governance-failure-capture"
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Install ll-governance-failure-capture with a standard copy or Codex/Claude adapter profile."
    )
