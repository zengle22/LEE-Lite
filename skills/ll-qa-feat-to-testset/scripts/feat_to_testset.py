#!/usr/bin/env python3
"""
CLI entrypoint for the lite-native feat-to-testset runtime.
"""
...
from feat_to_testset_common import validate_input_package
from feat_to_testset_runtime import (
...
def command_validate_input(args: argparse.Namespace) -> int:
    errors, result = validate_input_package(args.input, args.feat_ref, repo_root_from(args.repo_root, args.input))
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the feat-to-testset workflow.")
