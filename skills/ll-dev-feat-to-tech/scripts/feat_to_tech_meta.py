...
def selected_feat_snapshot(feature: dict[str, Any], resolved_axis: str) -> dict[str, Any]:
    ...
    return {
        ...
        "design_impact_required": bool(feature.get("design_impact_required")) if feature.get("design_impact_required") is not None else False,
        "candidate_design_surfaces": ensure_list(feature.get("candidate_design_surfaces")),
        "surface_map_ref": str(feature.get("surface_map_ref") or ""),
        "tech_owner_ref": str(feature.get("tech_owner_ref") or ""),
        "tech_action": str(feature.get("tech_action") or ""),
