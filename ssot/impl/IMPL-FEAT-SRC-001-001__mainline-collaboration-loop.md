---
id: IMPL-FEAT-SRC-001-001
ssot_type: IMPL
title: Mainline Collaboration Loop Implementation Task
status: active
version: v1
schema_version: 0.1.0
impl_root_id: impl-root-feat-src-001-001
...
source_refs:
  ...
  - TECH-FEAT-SRC-ADR001-003-006-UNIFIED-MAINLINE-20260324-RERUN5-001
owner: dev-owner
workflow_key: manual.impl.from-tech
workflow_instance_id: manual-impl-src-001-001-20260325
properties:
  feat_ref: FEAT-SRC-001-001
  tech_ref: TECH-FEAT-SRC-ADR001-003-006-UNIFIED-MAINLINE-20260324-RERUN5-001
...
- `ARCH-SRC-001-003`：external gate 作为独立 skill/consumer 存在
- 上游 TECH：`TECH-FEAT-SRC-ADR001-003-006-UNIFIED-MAINLINE-20260324-RERUN5-001`
- 上游 API：`lee gate submit-handoff`、`lee gate show-pending`
...
把 `cli/commands/gate/command.py` 接到 submit/show-pending 两个命令面。
...
- 若 `external gate` 接口面继续漂移，re-entry 结构可能需要返工。
