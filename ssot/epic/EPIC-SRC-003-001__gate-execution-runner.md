...
- Actors and Roles: target_users, trigger_scenarios, bridge_context.downstream_inheritance_requirements <- SRC-003, ADR-018, ADR-001, ADR-003, ADR-005, ADR-006, ADR-009
- Capability Scope: in_scope, governance_change_summary, bridge_context.governance_objects <- SRC-003, ADR-018, ADR-001, ADR-003, ADR-005, ADR-006, ADR-009
