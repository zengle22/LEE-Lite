...
title: formal 发布与下游准入流 Technical Design Package
status: accepted
schema_version: 1.0.0
workflow_key: dev.feat-to-tech
workflow_run_id: adr011-raw2src-fix-20260327-r1--feat-src-005-003
candidate_package_ref: artifacts/feat-to-tech/adr011-raw2src-fix-20260327-r1--feat-src-005-003
gate_decision_ref: artifacts/active/gates/decisions/feat-to-tech-adr011-raw2src-fix-20260327-r1--feat-src-005-003-tech-design-bundle-decision.json
frozen_at: '2026-03-29T14:26:54Z'
---

# formal 发布与下游准入流 Technical Design Package
...
- upstream_feat: FEAT-SRC-005-002
- downstream_feat: FEAT-SRC-005-004, FEAT-SRC-005-005
...
- arch_required: True
  ...
  - Keyword hits: 边界, boundary, path.
- api_required: True
  - API required by command-level contract surface.
  - Keyword hits: decision, consumer, handoff, event.

## TECH Design

- Design focus:
  - Freeze a concrete TECH design for formal 发布与下游准入流, preserving FEAT semantics while making runtime carriers and contracts implementation-ready.
- Implementation rules:
  ...
  - Approved decision leads to one explicit formal publication path: The FEAT must define one explicit approved decision -> formal publication -> admission chain without bypassing formal refs or lineage.
  - Consumer admission is formal-ref based: The FEAT must require formal refs and lineage-based admission rather than path guessing or adjacent file discovery.
  - Candidate and intermediate objects cannot pose as formal deliverables: The FEAT must prevent candidate or intermediate objects from being treated as the formal publication package.
...
- Need Assessment: scope, dependencies, acceptance_checks <- product.epic-to-feat::adr011-raw2src-fix-20260327-r1, FEAT-SRC-005-003, EPIC-SRC-005-001, SRC-005
- TECH Design: goal, scope, constraints <- product.epic-to-feat::adr011-raw2src-fix-20260327-r1, FEAT-SRC-005-003, EPIC-SRC-005-001, SRC-005
- Cross-Artifact Consistency: dependencies, outputs, acceptance_checks <- product.epic-to-feat::adr011-raw2src-fix-20260327-r1, FEAT-SRC-005-003, EPIC-SRC-005-001, SRC-005
