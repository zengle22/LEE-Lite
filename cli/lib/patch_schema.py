...
def test_all_existing_enum_values_validate() -> None:
    ...
    expected_values = {
        "ui_flow", "copy_text", "validation", "navigation", "layout",
    ...
    assert expected_values == actual_values, (
        f"Enum mismatch: missing={expected_values - actual_values}, extra={actual_values - expected_values}"
    )
